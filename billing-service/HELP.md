...
* The original package name 'org.miaad.billing-service' is invalid and this project uses 'org.miaad.billingservice' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#web.spring-hateoas)
